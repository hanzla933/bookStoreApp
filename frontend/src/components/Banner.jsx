        ...
        <div className="order-2 md:order-1 w-full md:w-1/2 mt:12 md:mt-32">
          <div className="space-y-12">
            ...
            <p className="  mt-4 text-xl">
              Lorem ipsum dolor sit amet, consectetur adipiscing el it. Sed
              veltristique nunc. Sed ac convallis neque. Donec in orci eget nisi
              consectetur egestas. Aliquam erat volutpat.
            </p>
